...
const CandidateList: React.FC = () => {
  ...
  const [flattenedCandidates, setFlattenedCandidates] = useState<FlattenedCandidate[]>([]);
  ...
  const [selectedCandidate, setSelectedCandidate] = useState<FlattenedCandidate | null>(null);
  ...
  return (
    <div className="candidate-list-container">
      ...
      <h1 className="candidate-list-heading">Danh sách ứng viên đã chọn (COMPLETED)</h1>
